...
namespace ClubCloud.Afhangen.UILogic.Services
{
    public class BaanServiceProxy : IBaanService
    {
        ...
        public async Task<Models.Baan> GetBaanAsync(Guid verenigingId, Guid accommodatieId, Guid baanId)
        {
            ...
            ObservableCollection<Models.Baan> _banen = new ObservableCollection<Models.Baan>();
            _banen = await GetBanenAsync(verenigingId, accommodatieId);
        ...
        public async Task<ObservableCollection<Models.Baan>> GetBanenAsync(Guid verenigingId, Guid accommodatieId)
        {
            ObservableCollection<Models.Baan> _banen = new ObservableCollection<Models.Baan>();

            //ObservableCollection<ClubCloud_Baan> banen = await client.GetBanenByVerenigingIdAsync("0000000", verenigingId, false);
            ObservableCollection<ClubCloud_Baan> banen = await client.GetBanenByAccommodatieIdAsync("0000000", verenigingId, accommodatieId, false);
