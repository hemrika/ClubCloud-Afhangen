...
namespace ClubCloud.Core.Unity.ObjectBuilder
{
    /// <summary>
    ...
    public static class SpecifiedMemberSelectorHelper
    {
            ...
            SelectedMemberWithParameters result)
        {
            ...
            ClubCloud.Core.Unity.Utility.Guard.ArgumentNotNull(parameterValues, "parameterValues");
            ClubCloud.Core.Unity.Utility.Guard.ArgumentNotNull(result, "result");
