...
namespace ClubCloud.Core.Unity.Utility
{
    /// <summary>
    ...
    public static class TypeReflectionExtensions
    {
        ...
        {
            ClubCloud.Core.Unity.Utility.Guard.ArgumentNotNull(parameters, "parameters");
            ClubCloud.Core.Unity.Utility.Guard.ArgumentNotNull(closedConstructorParameterTypes, "closedConstructorParameterTypes");
