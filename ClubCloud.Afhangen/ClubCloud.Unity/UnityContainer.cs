...
using ClubCloud.Core.Unity.ObjectBuilder;
using ClubCloud.Core.Unity.Properties;
using Guard = ClubCloud.Core.Unity.Utility.Guard;

namespace ClubCloud.Core.Unity
{
    /// <summary>
...
#pragma warning restore 618
        ...
        {
            ClubCloud.Core.Unity.Utility.Guard.ArgumentNotNull(extensions, "extensions");
