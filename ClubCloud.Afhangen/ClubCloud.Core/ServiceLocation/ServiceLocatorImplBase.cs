...
namespace ClubCloud.Core.ServiceLocation
{
    ...
    /// for most of the methods of <see cref="T:ClubCloud.Core.ServiceLocation.IServiceLocator" />.
    /// </summary>
    [CLSCompliant(true)]
    public abstract class ServiceLocatorImplBase : IServiceLocator, IServiceProvider
    {
        ...
        /// <summary>
        /// Format the exception message for use in an <see cref="T:ClubCloud.Core.ServiceLocation.ActivationException" />
        ...
        protected virtual string FormatActivateAllExceptionMessage(Exception actualException, Type serviceType)
        {
            ...
            string activateAllExceptionMessage = "Activation error occurred while trying to get all instances of type {0}";
        ...
        {
            CultureInfo currentUICulture = CultureInfo.CurrentUICulture;
            string activationExceptionMessage = "Activation error occurred while trying to get instance of type {0}, key \"{1}\"";
        ...
        /// <exception cref="T:ClubCloud.Core.ServiceLocation.ActivationException">if there is are errors resolving
        ...
        /// </summary>
        /// <param name="serviceType">Type of object requested.</param>
        /// <exception cref="T:ClubCloud.Core.ServiceLocation.ActivationException">if there is an error resolving
        /// the service instance.</exception>
        /// <returns>The requested service instance.</returns>
        ...
        /// <exception cref="T:ClubCloud.Core.ServiceLocation.ActivationException">if there is an error in resolving the service instance.</exception>
